...
import org.crusty.g2103.enemies.SquareEnemy;
import org.crusty.g2103.levels.LevelMaze;

public class SquareWaveSpawner extends WaveSpawner {

	public SquareWaveSpawner(Screen s, Cell start, int enemyNum, double speed, int hp) {
	...
	public void logic(long dt) {
		...
		if (Game.currentTimeMillis() - lastSpawnTime > timeBetweenEnemy) {
			...
			if (currentEnemyNum < enemyNum) {
				scr.addEntity(new SquareEnemy(s, scr.getMaze(), start, speed, hp));
